...
const UpdateOrderStatusDialog = ({ isVisible, onCancel, onSubmit }) => {
    ...
    <Modal isVisible={isVisible} style={{ margin: 0 }}>
      <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
        <View style={{ backgroundColor: 'white', width: 350, borderRadius: 10, padding: 20 }}>
          <Text style={[{ marginBottom: 10}, {fontSize: 13}, {fontStyle: 'normal'}, {fontWeight: '500'}]}>Please choose the status of the order:</Text>
          <Input
            value={cancelReason}
